      ...
      {open && (
        <div className="fixed bottom-24 right-6 z-50 w-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden animate-slideUp">
          ...
          <div className="p-4 space-y-3">
            <a
              href="https://wa.me/919509728788?text=Hi%2C%20I%20need%20help%20with%20Intellogy%20Coaching%20System"
              target="_blank"
          ...
          <div className="px-4 py-3 bg-gray-50 border-t border-gray-100">
            <p className="text-[10px] text-gray-400 text-center font-medium">Intellogy Coaching • Institute Management System</p>
          </div>
        </div>
      )}
    </>
